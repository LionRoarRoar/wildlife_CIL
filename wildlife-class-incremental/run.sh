...
CUDA_VISIBLE_DEVICES=0 python class_incremental_imagenet.py \
    ...
    --resume --rs_ratio 0.0 \
    --random_seed 1998 \
    --ckp_prefix seed_1998_rs_ratio_0.0_class_incremental_wildlife \
    2>&1 | tee log_seed_1998_rs_ratio_0.0_class_incremental_wildlife_nb_cl_fg_16_nb_cl_5_nb_protos_20.txt
