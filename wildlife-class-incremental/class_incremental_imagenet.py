...
from utils_imagenet.utils_dataset import split_images_labels, merge_images_labels, D3DatasetLoader
...
parser.add_argument('--dataset', default='ss_d3', type=str)
parser.add_argument('--datadir', default='data/ss_d3/', type=str)
parser.add_argument('--num_classes', default=26, type=int)
parser.add_argument('--num_workers', default=16, type=int, \
    help='the number of workers for loading data')
parser.add_argument('--nb_cl_fg', default=16, type=int, \
